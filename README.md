...
Boundary rule: a value equal to the threshold passes (strict-exceed, not inclusive-fail). Full sourcing and version history for every methodology decision is in the requirements document referenced in `openspec/`.
